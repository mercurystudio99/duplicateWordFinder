...
<head>
	...
	<script>
	  AIDBASE_CHATBOT_ID = 'q7ehiNCGHARRsTgjgen8f';
	</script>
                                            ...
                                            <div class="main-table">
                                                ...
                                                <div class="table-main-content">
                                                    ...
                                                    <div class="title-content">
                                                        ...
                                                        <textarea class="form-control input-check-dupe" rows="1" data-type="title" data-id="<?php echo $project['table_id']; ?>" id="<?php echo $project['table_id']."-title"; ?>"><?php echo $project['table_title']; ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="title-content">
                                                        ...
                                                        <textarea class="form-control input-check-dupe" rows="1" data-type="subtitle" data-id="<?php echo $project['table_id']; ?>" id="<?php echo $project['table_id']."-subtitle"; ?>"><?php echo $project['table_subtitle']; ?></textarea>
                                                    </div>
                                                    <div class="table-upper custom-mt">
                                                        <div class="table-upper-wrap">
                                                    ...
                                                    <div class="title-content title-content-keywords">
                                                        ...
                                                        <textarea class="form-control input-check-dupe table-keywords" style="height: 190px;" data-type="keywords" data-id="<?php echo $project['table_id']; ?>" id="<?php echo $project['table_id']."-keywords"; ?>"><?php echo $project['table_keywords']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row my-3">
                        ...
                        <div class="col-md-10">
                            <select title="Select Country" class="form-control country3-selectpicker" name="country">
                            </select>
                        </div>
                    </div>
                    <div class="row my-3">
                        ...
                        <div class="col-md-2 text-right">
                            <button type="button" class="btn btn-primary" id="project-search-btn"><i class="fa fa-search"></i> Search</button>
                        </div>
                    </div>
                    <div class="row m-3 appList"></div>
                </div>
            </div>
        </div>
    </div>
...
<ab-chat
  chatbotID="q7ehiNCGHARRsTgjgen8f"
  theme="dark"
  orientation="left"
  color="#8B5CF6"
