...
$(document).ready(function() {
    ...
    $(document).on('click', '#add-table-btn', function() {
        ...
        var newTable = '<div class="col-md-4 custom-table-col">\n' +
            ...
            '                                    <p contenteditable="true" class="form-control input-check-dupe" data-id="'+dataID+'" data-type="title" id="'+titleID+'"></p>\n' +
            '                                </div>\n' +
            '\n' +
            ...
            '                                    <p contenteditable="true" class="form-control input-check-dupe" data-id="'+dataID+'" data-type="subtitle" id="'+subtitleID+'"></p>\n' +
            '                                </div>\n' +
            '                                <div class="table-upper custom-mt">\n' +
            '                                    <div class="table-upper-wrap">\n' +
            ...
            '                                    <div contenteditable="true" class="form-control input-check-dupe table-keywords" data-id="'+dataID+'" data-type="keywords" id="'+keywordsID+'"></div>\n' +
            '                                </div>\n' +
            '                            </div>\n' +
            '                        </div>\n' +
            '                    </div>';
    ...
    $(document).on('focusout', '.input-check-dupe', function(e) {
        ...
        $.each($('.input-check-dupe'), function (index1, item) {
            ...
            twoDJsonObject[tableID][fieldType] = $(item).text();
        });
...
console.log(twoDJsonObject)
    ...
    function setCharacterCount(currentElement) {
        ...
        var charCount = currentElement.text().length;
